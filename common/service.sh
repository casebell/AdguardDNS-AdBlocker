...
iptables -t nat -D OUTPUT -p tcp --dport 53 -j DNAT --to 176.103.130.130:5353
iptables -t nat -D OUTPUT -p udp --dport 53 -j DNAT --to 176.103.130.130:5353
...
ip6tables -t nat -D OUTPUT -p tcp --dport 5353 -j DNAT --to 2a00:5a60::ad1:0ff
